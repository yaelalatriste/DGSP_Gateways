...
namespace Api.Gateway.WebClient.Proxy.Cendis.Expedientes.Queries
{
    public interface IQExpedienteCendiProxy
    {
    ...
    public class QExpedienteCendiProxy : IQExpedienteCendiProxy
    {

        private readonly string _apiGatewayUrl;
        private readonly HttpClient _httpClient;

        public QExpedienteCendiProxy(HttpClient httpClient, ApiGatewayUrl apiGatewayUrl, IHttpContextAccessor httpContextAccessor)
        {
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiGatewayUrl}cendis/expedientes/getAllExpedientes");
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiGatewayUrl}cendis/expedientes/getExpedientesByAnio/{anio}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiGatewayUrl}cendis/expedientes/getExpedientesByCategoria/{categoria}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiGatewayUrl}cendis/expedientes/getExpedientesByAnioCategoria/{anio}/{categoria}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiGatewayUrl}cendis/expedientes/getExpedienteById/{id}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiGatewayUrl}cendis/expedientes/visualizarEntregable/{area}/{anio}/{categoria}/{entregable}/{archivo}");
            request.EnsureSuccessStatusCode();
