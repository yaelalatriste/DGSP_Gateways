...
namespace Api.Gateway.WebClient.Proxy.Prestaciones.Expedientes.Commands
{
    ...
    public class CExpedientePrestacionesProxy : ICExpedientePrestacionesProxy
    {
        ...
        public CExpedientePrestacionesProxy(HttpClient httpClient, ApiGatewayUrl apiGatewayUrl, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<ExpedienteDto> CreateExpediente([FromForm] ExpedienteCreateCommand command)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiGatewayUrl}prestaciones/expedientes/createExpediente", formContent);
        ...
        public async Task<ExpedienteDto> UpdateExpediente([FromForm] ExpedienteUpdateCommand command)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiGatewayUrl}prestaciones/expedientes/updateExpediente", formContent);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<ExpedienteDto> DeleteExpediente([FromBody] ExpedienteDeleteCommand command)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiGatewayUrl}prestaciones/expedientes/deleteExpediente", content);
            request.EnsureSuccessStatusCode();
