...
namespace Api.Gateway.WebClient.Proxy.SMedicos.Expedientes.Commands
{
    ...
    public class CExpedienteSMedicosProxy : ICExpedienteSMedicosProxy
    {
        ...
        public CExpedienteSMedicosProxy(HttpClient httpClient, ApiGatewayUrl apiGatewayUrl, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<ExpedienteDto> CreateExpediente([FromForm] ExpedienteCreateCommand command)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiGatewayUrl}smedicos/expedientes/createExpediente", formContent);
        ...
        public async Task<ExpedienteDto> UpdateExpediente([FromForm] ExpedienteUpdateCommand command)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiGatewayUrl}smedicos/expedientes/updateExpediente", formContent);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<ExpedienteDto> DeleteExpediente([FromBody] ExpedienteDeleteCommand command)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiGatewayUrl}smedicos/expedientes/deleteExpediente", content);
            request.EnsureSuccessStatusCode();
