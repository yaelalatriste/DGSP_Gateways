...
namespace Api.Gateway.WebClient.Proxy.SMedicos.Expedientes.Queries
{
    public interface IQExpedienteSMedicosProxy
    {
    ...
    public class QExpedienteSMedicosProxy : IQExpedienteSMedicosProxy
    {

        private readonly string _apiGatewayUrl;
        private readonly HttpClient _httpClient;

        public QExpedienteSMedicosProxy(HttpClient httpClient, ApiGatewayUrl apiGatewayUrl, IHttpContextAccessor httpContextAccessor)
        {
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiGatewayUrl}smedicos/expedientes/getAllExpedientes");
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiGatewayUrl}smedicos/expedientes/getExpedientesByAnio/{anio}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiGatewayUrl}smedicos/expedientes/getExpedientesByCategoria/{categoria}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiGatewayUrl}smedicos/expedientes/getExpedientesByAnioCategoria/{anio}/{categoria}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiGatewayUrl}smedicos/expedientes/getExpedienteById/{id}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiGatewayUrl}smedicos/expedientes/visualizarEntregable/{area}/{anio}/{categoria}/{entregable}/{archivo}");
            request.EnsureSuccessStatusCode();
