...
namespace Api.Gateway.WebClient.Proxy.Seguros.Expedientes.Commands
{
    ...
    public class CExpedienteSegurosProxy : ICExpedienteSegurosProxy
    {
        ...
        public CExpedienteSegurosProxy(HttpClient httpClient, ApiGatewayUrl apiGatewayUrl, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<ExpedienteDto> CreateExpediente([FromForm] ExpedienteCreateCommand command)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiGatewayUrl}seguros/expedientes/createExpediente", formContent);
        ...
        public async Task<ExpedienteDto> UpdateExpediente([FromForm] ExpedienteUpdateCommand command)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiGatewayUrl}seguros/expedientes/updateExpediente", formContent);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<ExpedienteDto> DeleteExpediente([FromBody] ExpedienteDeleteCommand command)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiGatewayUrl}seguros/expedientes/deleteExpediente", content);
            request.EnsureSuccessStatusCode();
