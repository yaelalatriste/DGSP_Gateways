...
namespace Api.Gateway.WebClient.Proxy.Seguros.Expedientes.Queries
{
    public interface IQExpedienteSegurosProxy
    {
    ...
    public class QExpedienteSegurosProxy : IQExpedienteSegurosProxy
    {

        private readonly string _apiGatewayUrl;
        private readonly HttpClient _httpClient;

        public QExpedienteSegurosProxy(HttpClient httpClient, ApiGatewayUrl apiGatewayUrl, IHttpContextAccessor httpContextAccessor)
        {
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiGatewayUrl}seguros/expedientes/getAllExpedientes");
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiGatewayUrl}seguros/expedientes/getExpedientesByAnio/{anio}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiGatewayUrl}seguros/expedientes/getExpedientesByCategoria/{categoria}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiGatewayUrl}seguros/expedientes/getExpedientesByAnioCategoria/{anio}/{categoria}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiGatewayUrl}seguros/expedientes/getExpedienteById/{id}");
            request.EnsureSuccessStatusCode();
        ...
        {
            var request = await _httpClient.GetAsync($"{_apiGatewayUrl}seguros/expedientes/visualizarEntregable/{area}/{anio}/{categoria}/{entregable}/{archivo}");
            request.EnsureSuccessStatusCode();
