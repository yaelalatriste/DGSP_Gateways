...
namespace Api.Gateway.WebClient.Controllers.Cendis.Expedientes.Queries
{
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    [ApiController]
    [Route("cendis/expedientes")]
    public class QExpedienteController : ControllerBase
    {
        private readonly IQExpedienteCendiProxy _expediente;
        ...
        public QExpedienteController(IQExpedienteCendiProxy expediente, IQCTCategoriaProxy categorias, IQCTAsuntoProxy asuntos, 
