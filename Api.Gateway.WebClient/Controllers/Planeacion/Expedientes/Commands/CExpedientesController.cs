...
namespace Api.Gateway.WebClient.Controllers.Planeacion.Expedientes.Commands
{
    ...
    {
        private readonly ICExpedientePlaneacionProxy _expediente;

        public CExpedientesController(ICExpedientePlaneacionProxy expediente)
        {
