...
namespace Api.Gateway.WebClient.Controllers.SMedicos.Expedientes.Commands
{
    ...
    {
        private readonly ICExpedienteSMedicosProxy _expediente;

        public CExpedientesController(ICExpedienteSMedicosProxy expediente)
        {
