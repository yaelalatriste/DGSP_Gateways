...
namespace Api.Gateway.WebClient.Controllers.SMedicos.Expedientes.Queries
{
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    [ApiController]
    [Route("smedicos/expedientes")]
    public class QExpedienteController : ControllerBase
    {
        private readonly IQExpedienteSMedicosProxy _expediente;
        ...
        public QExpedienteController(IQExpedienteSMedicosProxy expediente, IQCTCategoriaProxy categorias, IQCTAsuntoProxy asuntos, 
                                     IQCTExpedienteProxy expedientes, IHostingEnvironment environment)
        {
        ...
        public async Task<IActionResult> GetExpedienteById(int id)
        {
            ...
            expedientes.Categoria = await _categorias.GetCategoriaByIdAsync(expedientes.CategoriaId);
            expedientes.Expediente = await _expedientes.GetExpedienteById(expedientes.EntregableId);
            expedientes.Expediente.Asunto = await _asuntos.GetAsuntoById(expedientes.Expediente.AsuntoId);
            return Ok(expedientes);
        }
