...
namespace Api.Gateway.Proxies.Cendis.Commands.Expedientes
{
    ...
    public class CExpedienteCendiProxy : ICExpedienteCendiProxy
    {
        ...
        public CExpedienteCendiProxy(HttpClient httpClient, IOptions<ApiUrls> apiUrls, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<ExpedienteDto> CreateExpediente([FromForm] ExpedienteCreateCommand command)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiUrls.CendisUrl}api/cendis/expedientes/createExpediente", formContent);
        ...
        public async Task<ExpedienteDto> UpdateExpediente([FromForm] ExpedienteUpdateCommand command)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.CendisUrl}api/cendis/expedientes/updateExpediente", formContent);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<ExpedienteDto> DeleteExpediente([FromBody] ExpedienteDeleteCommand command)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.CendisUrl}api/cendis/expedientes/deleteExpediente", content);
            request.EnsureSuccessStatusCode();
