...
namespace Api.Gateway.Proxies.Planeacion.Commands.Expedientes
{
    ...
    public class CExpedientePlaneacionProxy : ICExpedientePlaneacionProxy
    {
        ...
        public CExpedientePlaneacionProxy(HttpClient httpClient, IOptions<ApiUrls> apiUrls, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<ExpedienteDto> CreateExpediente([FromForm] ExpedienteCreateCommand command)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiUrls.PlaneacionUrl}api/planeacion/expedientes/createExpediente", formContent);
        ...
        public async Task<ExpedienteDto> UpdateExpediente([FromForm] ExpedienteUpdateCommand command)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.PlaneacionUrl}api/planeacion/expedientes/updateExpediente", formContent);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<ExpedienteDto> DeleteExpediente([FromBody] ExpedienteDeleteCommand command)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.PlaneacionUrl}api/planeacion/expedientes/deleteExpediente", content);
            request.EnsureSuccessStatusCode();
