...
namespace Api.Gateway.Proxies.Prestaciones.Commands.Expedientes
{
    public interface ICExpedientePrestacionesProxy
    {
    ...
    public class CExpedientePrestacionesProxy : ICExpedientePrestacionesProxy
    {
        private readonly ApiUrls _apiUrls;
        private readonly HttpClient _httpClient;

        public CExpedientePrestacionesProxy(HttpClient httpClient, IOptions<ApiUrls> apiUrls, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<ExpedienteDto> CreateExpediente([FromForm] ExpedienteCreateCommand command)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiUrls.PrestacionesUrl}api/prestaciones/expedientes/createExpediente", formContent);
        ...
        public async Task<ExpedienteDto> UpdateExpediente([FromForm] ExpedienteUpdateCommand command)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.PrestacionesUrl}api/prestaciones/expedientes/updateExpediente", formContent);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<ExpedienteDto> DeleteExpediente([FromBody] ExpedienteDeleteCommand command)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.PrestacionesUrl}api/prestaciones/expedientes/deleteExpediente", content);
            request.EnsureSuccessStatusCode();
