...
namespace Api.Gateway.Proxies.Seguros.Commands.Expedientes
{
    public interface ICExpedienteSegurosProxy
    {
    ...
    public class CExpedienteSegurosProxy : ICExpedienteSegurosProxy
    {
        private readonly ApiUrls _apiUrls;
        private readonly HttpClient _httpClient;

        public CExpedienteSegurosProxy(HttpClient httpClient, IOptions<ApiUrls> apiUrls, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<ExpedienteDto> CreateExpediente([FromForm] ExpedienteCreateCommand command)
        {
            ...
            var request = await _httpClient.PostAsync($"{_apiUrls.SegurosUrl}api/seguros/expedientes/createExpediente", formContent);
        ...
        public async Task<ExpedienteDto> UpdateExpediente([FromForm] ExpedienteUpdateCommand command)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.SegurosUrl}api/seguros/expedientes/updateExpediente", formContent);
            request.EnsureSuccessStatusCode();
        ...
        public async Task<ExpedienteDto> DeleteExpediente([FromBody] ExpedienteDeleteCommand command)
        {
            ...
            var request = await _httpClient.PutAsync($"{_apiUrls.SegurosUrl}api/seguros/expedientes/deleteExpediente", content);
            request.EnsureSuccessStatusCode();
